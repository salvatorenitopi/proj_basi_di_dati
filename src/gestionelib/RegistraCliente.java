 ...
 */
public class RegistraCliente extends javax.swing.JFrame {

    /**
     * Creates new form RegistraCliente
     */
    ...
    private void initComponents() {
        ...
        First_Label.setText("Registra nuovo cliente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistraCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void registra (){
        ...
        if (stato == 1) {
            ...
            catch(SQLException e)
            {
               ...
               JOptionPane.showMessageDialog(null,"Cliente Registrato");
               this.setVisible(false);
